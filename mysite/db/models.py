...
class UserProfile(Base):
    ...
    user_cart: Mapped['Cart'] = relationship('Cart',back_populates='user',cascade='all , delete-orphan')
    favorite_user: Mapped['Favorite'] = relationship('Favorite',back_populates='user',cascade='all, delete-orphan')
...
class SubCategory(Base):
    ...
    subcategory_name: Mapped[str] = mapped_column(String(32))

    category: Mapped['Category'] = relationship('Category', back_populates='sub_category')
    subcategory_product:Mapped[List['Product']] = relationship('Product',
...
class Product(Base):
    ...
    images_product:Mapped[List['ImageProduct']] = relationship('ImageProduct',back_populates='product',cascade='all, delete-orphan')
...
class Favorite(Base):
    ...
    favorite_item: Mapped[List['FavoriteItem']] = relationship('FavoriteItem',
